...
public class ServerInfoTextCHS
{
    ...
    public string StartingServer => "正在启动 HyacineDH…";
    public string CurrentVersion => "HyacineDH 支持的版本: {0}";
    ...
    public string MissionEnabled => "任务系统已启用，你需要关闭它，因为我们还不支持任务系统！";
...
{
    public string Desc =>
        "给予玩家全部指定类型的物品\navatar意为角色，equipment意为光锥，relic意为遗器，unlock意为气泡、手机壁纸、头像，skin意为皮肤，train意为开拓者房间内容，pet意为宠物，path意为多命途角色命途";
